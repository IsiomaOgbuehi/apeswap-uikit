...
const Info: React.FC<IconProps> = ({ direction = "right", color = "brown", width, getStyles }) => {
  const deg: rotation = {
    left: 180,
    up: 270,
    right: 0,
  ...
  return (
    <svg width={width || "24"} viewBox="0 0 28 22" fill="none" xmlns="http://www.w3.org/2000/svg" sx={style}>
      <path
